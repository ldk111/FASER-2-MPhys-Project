...
void extract_fluence_data(){
  ...
  TFile *f = new TFile("ROOT/mu_fluence.root", "RECREATE");

  std::string file_n = "C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/fluence Files/usrbin_Nmuons.txt";
  std::string file_p = "C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/fluence Files/usrbin_Pmuons.txt";
