...
// files
std::string outpath_mu = "C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/histos/mu_flux_histograms.root";
TFile *fin; //input
TFile *fout; //output
...
void make_muon_flux_histos(){
  ...
  // negative muons
  fin = new TFile("C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/ROOT/Nmu_data.root", "READ");
  ...
  // positive muons
  fin = new TFile("C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/ROOT/Pmu_data.root", "READ");
