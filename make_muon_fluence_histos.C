...
std::string outpath = "C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/histos/mu_fluence_histograms.root";
TFile *f; //input 
TFile *fout; //output
...
void make_muon_fluence_histos(){
  ...
  //input
  f = new TFile("C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/ROOT/mu_fluence.root", "READ");
