...
// files
std::string outpath_mu = "C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/histos/mu_flux_histograms_txt.root";
TFile *fin; //input
TFile *fout; //output
...
void set_tree(TTree *t){
  ...
  std::cout << "Setting Tree Initiated";
  ...
  std::cout << "Setting Tree Completed";
}

void make_histos(TTree *t, std::string name){

  std::cout << "Making Histos Initiated";
  ...
  // save to image
  std::string path = "figs/flux_"+name+"_txt_FPF_entrance.png"; 
  ...
  std::cout << "Making Histos Completed";
}


void make_muon_flux_histos_txt(){
  ...
  // negative muons
  fin = new TFile("C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/ROOT/Nmu_data_txt.root", "READ");
  ...
  // positive muons
  fin = new TFile("C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/ROOT/Pmu_data_txt.root", "READ");
