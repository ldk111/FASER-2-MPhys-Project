...
// files
std::string outpath_n = "C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/histos/n_flux_histograms.root";
TFile *fin; //input
TFile *fout; //output
...
void make_neutron_flux_histos(){
  ...
  fin = new TFile("C:/Users/luke/OneDrive/Documents/MPhys Project/Files/Muon Background Simulation/macros/ROOT/Neutron_data.root", "READ");
